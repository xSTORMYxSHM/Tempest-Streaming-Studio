...
export const blackHoleWorkflow: TempestWorkflowDefinition = {
  ...
  name: 'Tempest Creator Pack · Black Hole Event',
  description: 'Optional example for a creator setup with Warudo, Tempest Broadcast, Quartic Pulse, and Data Horizon.',
  enabled: false,
...
export const soundAlertPerformanceWorkflow: TempestWorkflowDefinition = {
  ...
  description: 'Routes an Interaction Alert to any configured avatar and broadcast reactions for its supplied duration.',
  enabled: true,
...
export const twitchAlertReactionWorkflow: TempestWorkflowDefinition = {
  ...
  description: 'Keeps a compatible broadcast reaction active while the Twitch Alert Browser Source owns media and audio.',
  enabled: true,
